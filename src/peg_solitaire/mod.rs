use super::generative_evaluation_tree::GenerativeEvaluationTreeNode;
use super::generative_evaluation_tree::GenerativeEvaluationTree;
...
impl GenerativeEvaluationTreeNode<TrianglePegNode> for TrianglePegNode {
...
mod tests {
    ...
    fn test_triangle_peg_search() {
        ...
        let mut tree = GenerativeEvaluationTree::new(root_node, 100);
