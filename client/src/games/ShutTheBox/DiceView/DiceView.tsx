import styles from "@/styles/DiceView.module.css";
...
export function DiceView(props: DiceViewProps): JSX.Element {
  return (
    <div className={`${styles.dice}`}>
      <DieView die={props.gameState.d1} setDie={props.setDie1} />
      <DieView die={props.gameState.d2} setDie={props.setDie2} />
    </div>
  );
}
...
function DieView(props: DieViewProps): JSX.Element {
  return (
    ...
    >
      <span className={`${styles.die_value}`}>
